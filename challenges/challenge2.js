 ...
 *
 *    This will print 'Hello there, Ducky' and then 'MAKE SCHOOL IS AWESOME'
 *    This is because we're using .then() which will wait until the Promise is
 *    Resolved before doing the next step
 *
 ...
 *
 *    If any Promise in the chain is rejected, the .catch() will halt all future
 *    Promises. So uppercaser() will not run.
 *
 ...
 *    run the code again.
 *
 *   The greet code will be executed, then the error log in the catch() will be
 *   executed.
 *
...
name = 'Ducky'
my_str = 'Promises are fun!'
notSpaced = 'abcdefghijklmnopqrstuvwxyz'
